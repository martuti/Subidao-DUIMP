...
path = "C:\\Users\\fcherpin\\OneDrive - Donaldson Company, Inc\\Desktop\\Subidão DUIMP\\Plan DUIMP Project"
...
while True:
    try:
        ...
        df = pd.read_excel(
            planilha_path,
            sheet_name="TBD_ListaItensDuimp",
...
planilha_path = path + '\\Lista de Itens DUIMP.xlsx'
try:
    df = pd.read_excel(planilha_path, sheet_name="TBD_ListaItensDuimp", usecols=["Produto", "NCM", "Forn 1", "País", "Des Fornec 1", "codigo", "Descricao Sistema"], dtype=str).dropna()
            ...
            try:
                ...
                try:
                    ...
                    for i, registro in enumerate(registros, start=2):  # Começa na linha 2
                        ...
                        if forma_preenchimento == "NUMERO_INTEIRO" and isinstance(resposta, int):
                    ...
                    script_path = os.path.join(r"C:\Users\fcherpin\OneDrive - Donaldson Company, Inc\Desktop\Subidão #DUIMP\Robo DUIMP", "automacao_duimp_cherps.py")
                    try:
...
def mover_item_para_feito(planilha_path, linha_item):
    ...
    try:
        ...
        # Selecionar as abas
        aba_tbd = wb["TBD_ListaItensDuimp"]
        aba_feito = wb["Feito_ListaItensDuimp"]
